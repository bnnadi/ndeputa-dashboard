...
export default class ComposeMail extends Component {
  ...
  render() {
    ...
    return (
      <ComposeForm className="nnaComposeMailWrapper">
        <ComposeAutoComplete {...ComposeAutoCompleteTO} />
        <ComposeAutoComplete {...ComposeAutoCompleteCC} />
        <Input placeholder="Subject" className="nnaInputBox" />
        <Editor {...editorOption} />
        <div className="nnaComposeMailBtnWrapper">
