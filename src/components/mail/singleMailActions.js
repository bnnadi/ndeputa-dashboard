...
export default class extends Component {
  render() {
    ...
    return (
      <SingleMailActions className="nnaMailActionsController">
        {toggleListVisible ? (
        ...
        <MailActionsWrapper className="nnaMailActions">
          <button
            type="button"
        ...
        <MailCategoryWrapper className="nnaMailMove">
          <MoveMailButton />
          <SelectTagButton />
        </MailCategoryWrapper>

        <MailPaginationWrapper className="nnaSingleMailPagination">
          {index === 0 ? (
            ''
          ) : (
            <button
