...
export default class ContactList extends Component {
  ...
  singleContact(contact) {
    ...
    return (
      <div
        key={contact.id}
        className={`${activeClass} nnaSingleContact`}
        onClick={onChange}
      >
        <div className="nnaAvatar">
          {contact.avatar ? <img alt="#" src={contact.avatar} /> : ''}
        </div>
        <div className="nnaContactName">
  ...
  render() {
    ...
    return (
      <ContactListWrapper className="nnaContactListWrapper">
        <InputSearch
